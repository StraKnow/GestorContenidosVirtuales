  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gcvesanApp.employee.home.createOrEditLabel">
            <Translate contentKey="gcvesanApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="gcvesanApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="commissionPctLabel" for="employee-commissionPct">
                  <Translate contentKey="gcvesanApp.employee.commissionPct">Commission Pct</Translate>
                </Label>
                <AvField id="employee-commissionPct" type="string" className="form-control" name="commissionPct" />
              </AvGroup>
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="gcvesanApp.employee.manager">Manager</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="gcvesanApp.employee.department">Department</Translate>
                </Label>
