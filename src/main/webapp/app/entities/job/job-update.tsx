  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gcvesanApp.job.home.createOrEditLabel">
            <Translate contentKey="gcvesanApp.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="job-employee">
                  <Translate contentKey="gcvesanApp.job.employee">Employee</Translate>
                </Label>
