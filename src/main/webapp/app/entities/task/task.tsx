...
export const Task = (props: ITaskProps) => {
  ...
  return (
    <div>
      <h2 id="task-heading">
        <Translate contentKey="gcvesanApp.task.home.title">Tasks</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gcvesanApp.task.home.createLabel">Create new Task</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gcvesanApp.task.home.search')}
                />
        ...
        {taskList && taskList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gcvesanApp.task.title">Title</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.task.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gcvesanApp.task.home.notFound">No Tasks found</Translate>
            </div>
          )
        )}
      </div>
