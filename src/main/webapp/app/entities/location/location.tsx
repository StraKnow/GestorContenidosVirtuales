  ...
  return (
    <div>
      <h2 id="location-heading">
        <Translate contentKey="gcvesanApp.location.home.title">Locations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gcvesanApp.location.home.createLabel">Create new Location</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gcvesanApp.location.home.search')}
                />
        ...
        {locationList && locationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gcvesanApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.location.stateProvince">State Province</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.location.country">Country</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gcvesanApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
