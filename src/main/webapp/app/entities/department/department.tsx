  ...
  return (
    <div>
      <h2 id="department-heading">
        <Translate contentKey="gcvesanApp.department.home.title">Departments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="gcvesanApp.department.home.createLabel">Create new Department</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('gcvesanApp.department.home.search')}
                />
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="gcvesanApp.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="gcvesanApp.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gcvesanApp.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
